      ...
      <Navbar className={styles.navBar}>
        ...
        <Navbar.Collapse>
          <Nav className={styles.nav}>
            <Nav.Link className={styles.navLink} href="Home">Envoyer des fichiers</Nav.Link>
            <Nav.Link className={styles.navLink} href="Settings">Mes informations personnelles</Nav.Link>
          </Nav>
